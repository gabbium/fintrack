...
namespace Fintrack.ServiceName.Api.FunctionalTests.TestHelpers.Infrastructure.Containers;
...
public class PostgresContainer
{
    ...
    public async ValueTask InitializeAsync()
    {
        ...
        using var dbContext = new DbContextName(dbOptions, identityService);
