...
public class GetMovementByIdTests(TestFixture fx) : TestBase(fx)
{
    ...
    [Fact]
    public async Task GivenLoggedInUser_WhenGettingExisting_ThenOkWithBody()
    {
    ...
    [Fact]
    public async Task GivenLoggedInUser_WhenGettingExistingOtherUsers_ThenNotFoundWithProblem()
    {
        _auth.Given_LoggedInUser();
    ...
    [Fact]
    public async Task GivenLoggedInUser_WhenGettingNonExistent_ThenNotFoundWithProblem()
    {
        _auth.Given_LoggedInUser();
    ...
    [Fact]
    public async Task GivenLoggedInUser_WhenGettingWithInvalidId_ThenBadRequestWithValidation()
    {
        _auth.Given_LoggedInUser();
    ...
    [Fact]
    public async Task GivenAnonymousUser_WhenGetting_ThenUnauthorizedWithBearerChallenge()
    {
